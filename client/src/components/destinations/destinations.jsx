...
export default function Destinations() {
  ...
  const Destination2 = DestinationData[17];
  const Destination3 = DestinationData[21];
  const Destination4 = DestinationData[18];
  const Destination5 = DestinationData[24];
  const Destination6 = DestinationData[13];
  const Destination7 = DestinationData[8];
  const Destination8 = DestinationData[23];
  const Destination9 = DestinationData[3];
  const Destination10 = DestinationData[1];
  const Destination11 = DestinationData[16];
  const Destination12 = DestinationData[2];
  const Destination13 = DestinationData[7];
  const Destination14 = DestinationData[5];
  const Destination15 = DestinationData[4];
  const Destination16 = DestinationData[9];
  const Destination17 = DestinationData[6];
  const Destination18 = DestinationData[12];
  const Destination19 = DestinationData[15];
  const Destination20 = DestinationData[19];
  const Destination21 = DestinationData[20];
  const Destination22 = DestinationData[22];
  const Destination23 = DestinationData[15];
  const Destination24 = DestinationData[10];
  const Destination25 = DestinationData[11];
    ...
    <div className="my-16 grid grid-cols-3 gap-6">
      <div className="grid grid-rows-5 gap-6 overflow-hidden rounded-md">
        <Link to={'/destinations'} className="row-span-3 relative destination-card overflow-hidden rounded-md">
          <span className="absolute bottom-6 left-6 z-10">
      ...
      <div className="grid grid-rows-1 overflow-hidden rounded-md">
      ...
      <div className="grid grid-rows-2 gap-6 overflow-hidden rounded-md">
        ...
        <Link to={'/destinations'} className="relative destination-card overflow-hidden rounded-md">
          ...
          <img className="h-full rounded-md destination-card-image" src={Destination8.image} alt="Destination Image" />
        </Link>
      </div>
      <div className="grid grid-rows-3 gap-6 overflow-hidden rounded-md">
        <Link to={'/destinations'} className="row-span-1 relative destination-card overflow-hidden rounded-md">
          ...
          <img className="h-full w-full rounded-md destination-card-image" src={Destination9.image} alt="Destination Image" />
        </Link>
        <Link to={'/destinations'} className="row-span-2 relative destination-card overflow-hidden rounded-md">
          <span className="absolute bottom-6 left-6 z-10">
          ...
          <img className="h-full rounded-md destination-card-image" src={Destination10.image} alt="Destination Image" />
        </Link>
      </div>
      <div className="grid grid-rows-5 gap-6 overflow-hidden rounded-md">
        <Link to={'/destinations'} className="row-span-3 relative destination-card overflow-hidden rounded-md">
          ...
          <img className="h-full w-full rounded-md destination-card-image" src={Destination11.image} alt="Destination Image" />
        </Link>
        <Link to={'/destinations'} className="row-span-2 relative destination-card overflow-hidden rounded-md">
          <span className="absolute bottom-6 left-6 z-10">
          ...
          <img className="h-full rounded-md destination-card-image" src={Destination12.image} alt="Destination Image" />
        </Link>
      </div>
      <div className="grid grid-rows-1 overflow-hidden rounded-md">
        <Link to={'/destinations'} className="relative destination-card overflow-hidden rounded-md">
          ...
          <img className="h-fit w-full rounded-md destination-card-image" src={Destination13.image} alt="Destination Image" />
        </Link>
      </div>
      <div className="grid grid-rows-5 gap-6 overflow-hidden rounded-md">
        <Link to={'/destinations'} className="row-span-3 relative destination-card overflow-hidden rounded-md">
          ...
          <img className="h-full w-full rounded-md destination-card-image" src={Destination14.image} alt="Destination Image" />
        </Link>
        <Link to={'/destinations'} className="row-span-2 relative destination-card overflow-hidden rounded-md">
          <span className="absolute bottom-6 left-6 z-10">
          ...
          <img className="h-full rounded-md destination-card-image" src={Destination15.image} alt="Destination Image" />
        </Link>
      </div>
      <div className="grid grid-rows-2 gap-6 overflow-hidden rounded-md">
        <Link to={'/destinations'} className="relative destination-card overflow-hidden rounded-md">
          ...
          <img className="h-full w-full rounded-md destination-card-image" src={Destination16.image} alt="Destination Image" />
        </Link>
        <Link to={'/destinations'} className="relative destination-card overflow-hidden rounded-md">
          <span className="absolute bottom-6 left-6 z-10">
          ...
          <img className="h-full rounded-md destination-card-image" src={Destination17.image} alt="Destination Image" />
        </Link>
      </div>
      <div className="grid grid-rows-1 overflow-hidden rounded-md">
        <Link to={'/destinations'} className="relative destination-card overflow-hidden rounded-md">
      ...
      <div className="grid grid-rows-1 gap-6 overflow-hidden rounded-md">
        <Link to={'/destinations'} className="relative destination-card overflow-hidden rounded-md">
          <span className="absolute bottom-6 left-6 z-10">
            <h3 className="text-lg text-[#FCC603] font-semibold">{Destination25.place}</h3>
            <p className="text-xl text-[#FCC603] font-bold">{Destination25.country}</p>
          </span>
          <img className="h-full w-full rounded-md destination-card-image" src={Destination25.image} alt="Destination Image" />
        </Link>
      </div>
    </div>
  )

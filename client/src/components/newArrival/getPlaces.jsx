    ...
    <div key={index} className="w-full md:w-1/3 lg:w-1/4 px-4 mb-8">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-50 py-2 px-4 text-white">
          ...
          <Link
            className="px-8 ml-6 py-2 text-center font-bold text-[#029D9D] hover:text-white bg-black border-2 border-white hover:bg-[#029D9D] rounded-md transition-all duration-200"
            to={`/places/${place._id}`}
          >
            Book now
          </Link>
